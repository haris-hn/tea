...
const ProductDetail = () => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        if (data.variants && data.variants.length > 0) {
          ...
          console.error("No variants found for product:", data);
        }
  ...
  const handleAddToCart = async () => {
    if (!selectedVariant?._id) {
      alert("This product has no variant. Please fix product data.");
      console.error("Invalid variant:", selectedVariant);
      return;
    }

    setAddingToCart(true);

    const res = await addToCart(selectedVariant._id, quantity);

    if (!res.success) {
      console.error("Cart error:", res.message);
    }
  ...
  if (loading)
    return (
      <div className="p-24 text-center font-bold tracking-widest uppercase text-gray-400 font-outfit">
        Loading Tea Details...
      </div>
    );
  if (error || !product)
    return (
      <div className="p-24 text-center text-red-500 font-bold uppercase font-outfit">
    ...
    <div className="bg-white font-outfit">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          <div className="bg-gray-50 aspect-square overflow-hidden border border-gray-100 shadow-sm">
            <img
              src={
                product.images?.[0] ||
                "https://images.unsplash.com/photo-1594631252845-29fc45865157?q=80&w=1000&auto=format&fit=crop"
              }
              alt={product.name}
            ...
            <div className="space-y-4 font-outfit">
              ...
              <div className="flex flex-wrap gap-2">
                {product.variants.map((v) => {
                  ...
                  let iconType = "bag";
                  if (sizeText.includes("170") || sizeText.includes("tin"))
                    iconType = "tin";
      ...
      <div className="bg-[#f5f5f5] py-20 border-y border-gray-100 font-outfit">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="space-y-8">
            <h2 className="text-3xl tracking-wide text-gray-800 font-light mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-grow border-b border-gray-300 pb-3">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-gray-900 mr-2">
                    Serving Size:
                  </span>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-grow border-b border-gray-300 pb-3">
                  ...
                  <span className="text-[13px] text-gray-600 font-medium">
                    {product.steepingInstructions?.waterTemp || "100°C"}
                  </span>
                </div>
              </div>
          ...
          <div className="space-y-12">
            <h2 className="text-3xl tracking-wide text-gray-800 font-light">
              About this tea
            </h2>
            ...
            <div className="flex items-start justify-between border-gray-200">
              ...
              <div className="flex-1 px-4 text-center">
                ...
                <p className="text-[12px] text-gray-500 font-medium capitalize">
                  {Array.isArray(product.details?.qualities)
                    ? product.details.qualities.join(", ")
                    : product.details?.qualities || "Soothing"}
                </p>
              </div>
              <div className="w-px h-10 bg-gray-300 mt-1"></div>
              ...
              <div className="flex-1 px-4 text-center">
                ...
                <p className="text-[12px] text-gray-500 font-medium capitalize">
                  {Array.isArray(product.details?.caffeine)
                    ? product.details.caffeine.join(", ")
                    : product.details?.caffeine || "Medium"}
                </p>
              </div>
              <div className="w-px h-10 bg-gray-300 mt-1"></div>
              ...
              <div className="flex-1 pl-4 text-right md:text-left">
                ...
                <p className="text-[12px] text-gray-500 font-medium capitalize">
                  {Array.isArray(product.details?.allergens)
                    ? product.details.allergens.join(", ")
                    : product.details?.allergens || "Nuts-free"}
                </p>
              </div>
            </div>
            ...
            {/* Ingredients */}
            <div className="pt-2">
              <h3 className="text-2xl tracking-wide text-gray-800 font-light mb-4">
                Ingredient
              </h3>
